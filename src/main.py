...
plt.annotate('Test error: '+ "{:.2f}".format(testing_error[0]) + ' Test accuracy: '+ "{:.4f}".format(testing_error[1]), (0,0), (0, -20), xycoords='axes fraction', textcoords='offset points', va='top', color='red')
plt.show()
